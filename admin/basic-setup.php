...
add_filter( 'plugin_action_links_' . LOGINID_DWP_STARTER_PLUGIN . '/loginid_dwp_loginid-directweb-plugin.php', 'loginid_dwp_settings_link' );
...
function loginid_dwp_footer_text($default) {
    ...
    $loginid_dwp_footer_text = sprintf( __( 'If you like this plugin, please <a href="%s" target="_blank">make a donation</a> or leave me a <a href="%s" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating to support continued development. Thanks a bunch!', 'loginid-directweb-plugin' ), 
...
function loginid_dwp_footer_version($default) {
	...
	return 'Plugin version ' . LOGINID_DWP_VERSION_NUM;
}
